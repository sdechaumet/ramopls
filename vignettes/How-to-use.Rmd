---
title: "How to use rAMOPLS"
author: "Sylvain Dechaumet"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{How to use rAMOPLS}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
csl: plant-physiology.csl
bibliography: rAMOPLS_bibliography.bib
---
...
The AMOPLS method depends on the kopls package which is available [here](http://kopls.sourceforge.net/index.shtml). A copy of the package sources is implemented inside the `rAMOPLS` and can be installed with `rAMOPLS::install_kopls()`.
